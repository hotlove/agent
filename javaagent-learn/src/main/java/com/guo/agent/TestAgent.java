...
//        System.out.println("premain done");
        ...
        // (com.badu.bdsaas.baseinfo.*|com.badu.btsaas.controller.*)
        new AgentBuilder
                .Default()
                .type(ElementMatchers.<TypeDescription>nameMatches("(com.badu.bdsaas.baseinfo.service.*|com.badu.btsaas.controller.*)"))
